/*
 * imx-3stack-ALC5623.c  --  i.MX 3Stack Driver for Freescale ALC5623 Codec
 *
...
static unsigned int alc5623_rates[] = {
	0,
	32000,
	44100,
	48000,
...
/*
 * imx_3stack ALC5623 audio DAI opserations.
 */
...
static int alc5623_jack_func;
static int alc5623_spk_func;
static int alc5623_line_in_func;
...
static int alc5623_set_jack(struct snd_kcontrol *kcontrol,
			     struct snd_ctl_elem_value *ucontrol)
{
	...
	alc5623_jack_func = ucontrol->value.enumerated.item[0];
	if (alc5623_jack_func)
...
static int alc5623_set_spk(struct snd_kcontrol *kcontrol,
			    struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_codec *codec = snd_kcontrol_chip(kcontrol);
	...
	alc5623_spk_func = ucontrol->value.enumerated.item[0];
	if (alc5623_spk_func)
...
static int alc5623_set_line_in(struct snd_kcontrol *kcontrol,
			     struct snd_ctl_elem_value *ucontrol)
{
	struct snd_soc_codec *codec = snd_kcontrol_chip(kcontrol);
	...
	alc5623_line_in_func = ucontrol->value.enumerated.item[0];
	if (alc5623_line_in_func)
...
static const struct snd_kcontrol_new alc5623_machine_controls[] = {
	SOC_ENUM_EXT("Jack Function", alc5623_enum[0], alc5623_get_jack,
		     alc5623_set_jack),
	SOC_ENUM_EXT("Speaker Function", alc5623_enum[1], alc5623_get_spk,
		     alc5623_set_spk),
	SOC_ENUM_EXT("Line In Function", alc5623_enum[1], alc5623_get_line_in,
		     alc5623_set_line_in),
};
...
static struct platform_driver imx_3stack_alc5623_audio_driver = {
	.probe = imx_3stack_alc5623_probe,
	.remove = imx_3stack_alc5623_remove,
	.driver = {
...
MODULE_DESCRIPTION("ALC5623 Driver for i.MX 3STACK");
MODULE_LICENSE("GPL");
